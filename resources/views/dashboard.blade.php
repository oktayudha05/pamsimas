<x-app-layout>
    ...
    <div class="space-y-4">
        ...
        <!-- Row 1: Stats Cards (3 tiles) -->
        <div class="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">

            <!-- Tile: Total Petugas -->
            <div class="bg-[#36656B] rounded-2xl p-4 sm:p-6 flex flex-col justify-between">
                ...
                <p class="text-3xl sm:text-5xl font-bold text-white mt-3 sm:mt-4">{{ $data['total_petugas'] }}</p>
            </div>

            <!-- Tile: Total Warga -->
            <div class="bg-[#75B06F] rounded-2xl p-4 sm:p-6 flex flex-col justify-between">
                <div class="flex items-start justify-between">
                ...
                <p class="text-3xl sm:text-5xl font-bold text-white mt-3 sm:mt-4">{{ $data['total_warga'] }}</p>
            </div>

            <!-- Tile: Pemakaian Bulan Ini (melebar penuh di HP karena 2 kolom, jadi dibuat col-span-2 di mobile) -->
            <div class="col-span-2 sm:col-span-1 bg-[#DAD887] rounded-2xl p-4 sm:p-6 flex flex-col justify-between">
                <div class="flex items-start justify-between">
                ...
                <p class="text-3xl sm:text-5xl font-bold text-[#36656B] mt-3 sm:mt-4">{{ number_format($data['total_meteran']) }} <span class="text-base sm:text-xl font-normal">m³</span></p>
            </div>
        </div>

        <!-- Row 2: Welcome Banner + Info Periode -->
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">

            <!-- Welcome Tile (melebar di mdl ke atas) -->
            <div class="md:col-span-2 bg-white rounded-2xl p-5 sm:p-6 border border-[#DAD887]/50">
                <div class="flex items-start gap-3 sm:gap-4">
                    ...
                    <div class="min-w-0">
                        ...
                        <p class="text-gray-400 text-sm mt-2 sm:mt-3">
            ...
            <!-- Info Periode Tile -->
            <div class="bg-[#F0F8A4] rounded-2xl p-5 sm:p-6 flex flex-col justify-between">
                <div>
                    <p class="text-[#36656B] text-xs font-semibold uppercase tracking-widest mb-2">Periode</p>
                    <p class="text-[#36656B] text-xl sm:text-2xl font-bold">{{ now()->translatedFormat('F Y') }}</p>
                </div>
